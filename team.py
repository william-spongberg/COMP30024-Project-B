...
metadata = {
    ...
    "team_members": [
        {
            "name": "William Spongberg",
            "student_id": "1354263",
            "email": "wspongberg@student.unimelb.edu.au" # Must be @student.unimelb.edu.au address
        },
        {
            "name": "Gaoyongle Zhang",
            "student_id": "1346309",
            "email": "gaoyonglez@student.unimelb.edu.au" # Must be @student.unimelb.edu.au address
        }
    ],
}
